...
public class ESResultSet implements ResultSet {
    ...
    private long getTimeFromString(String value) throws SQLException {
        try {
            // Migrated to java.time (JSR-310) - a core part of the JDK which replaces the Joda project.
    ...
    public Date getDate(int columnIndex) throws SQLException {
        ...
        if (type == Types.DATE) {
            ...
            throw new SQLException("Value in column '" + columnIndex + "' is not a Date but is " + value.getClass().getSimpleName());
    }
    ...
    public Time getTime(int columnIndex) throws SQLException {
        ...
        if (type == Types.TIMESTAMP) {
            ...
            throw new SQLException("Value in column '" + columnIndex + "' is not a Time but is " + value.getClass().getSimpleName());
    }
    ...
    public Timestamp getTimestamp(int columnIndex) throws SQLException {
        ...
        if (type == Types.DATE || type == Types.TIMESTAMP) {
            ...
            throw new SQLException("Value in column '" + columnIndex + "' is not a Timestamp but is " + value.getClass().getSimpleName());
    }
